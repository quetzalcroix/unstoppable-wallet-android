...
class SwapCoinProvider(
    ...
    private fun dexSupportsCoin(coin: Coin) = when (coin.type) {
        CoinType.Ethereum, is CoinType.Erc20 -> dex.blockchain == Dex.Blockchain.Ethereum
        CoinType.BinanceSmartChain, is CoinType.Bep20 -> dex.blockchain == Dex.Blockchain.BinanceSmartChain
        else -> false
    }
