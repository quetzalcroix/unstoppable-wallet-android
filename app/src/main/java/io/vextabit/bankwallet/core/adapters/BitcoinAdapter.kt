...
class BitcoinAdapter(
    ...
    companion object {
        ...
        private fun createKit(wallet: Wallet, syncMode: SyncMode?, testMode: Boolean): BitcoinKit {
            ...
            return BitcoinKit(context = io.vextabit.bankwallet.core.App.instance,
        ...
        fun clear(walletId: String, testMode: Boolean) {
            BitcoinKit.clear(io.vextabit.bankwallet.core.App.instance, getNetworkType(testMode), walletId)
        }
    }
}
