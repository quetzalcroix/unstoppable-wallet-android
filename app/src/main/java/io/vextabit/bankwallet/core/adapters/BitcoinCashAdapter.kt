package io.vextabit.bankwallet.core.adapters
...
class BitcoinCashAdapter(
    ...
    companion object {
        ...
        private fun createKit(wallet: Wallet, syncMode: SyncMode?, testMode: Boolean): BitcoinCashKit {
            ...
            return BitcoinCashKit(context = io.vextabit.bankwallet.core.App.instance,
        ...
        fun clear(walletId: String, testMode: Boolean) {
            BitcoinCashKit.clear(io.vextabit.bankwallet.core.App.instance, getNetworkType(testMode), walletId)
        }
