...
class LitecoinAdapter(
    ...
    companion object {
        ...
        private fun createKit(wallet: Wallet, syncMode: SyncMode?, testMode: Boolean): LitecoinKit {
            ...
            return LitecoinKit(context = io.vextabit.bankwallet.core.App.instance,
        ...
        fun clear(walletId: String, testMode: Boolean) {
            LitecoinKit.clear(io.vextabit.bankwallet.core.App.instance, getNetworkType(testMode), walletId)
        }
    }
}
