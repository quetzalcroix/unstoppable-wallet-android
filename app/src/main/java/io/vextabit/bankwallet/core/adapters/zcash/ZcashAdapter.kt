package io.vextabit.bankwallet.core.adapters.zcash
...
class ZcashAdapter(
    ...
    companion object {
        ...
        fun clear(accountId: String, testMode: Boolean) {
            ...
            Initializer.erase(io.vextabit.bankwallet.core.App.instance, network, getValidAliasFromAccountId(accountId))
        }
    }
}
