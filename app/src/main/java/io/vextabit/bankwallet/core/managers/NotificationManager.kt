...
class NotificationManager(
    ...
    private fun showNotification(notification: AlertNotification) {
        val builder = NotificationCompat.Builder(io.vextabit.bankwallet.core.App.instance, channelId)
    ...
    private fun getPendingIntent(): PendingIntent {
        val intent = Intent(io.vextabit.bankwallet.core.App.instance, LauncherActivity::class.java).apply {
            flags = Intent.FLAG_ACTIVITY_NEW_TASK or Intent.FLAG_ACTIVITY_CLEAR_TASK
        }
        return PendingIntent.getActivity(io.vextabit.bankwallet.core.App.instance, 0, intent, 0)
    }
