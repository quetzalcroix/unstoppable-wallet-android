package io.vextabit.bankwallet.modules.manageaccount
...
object ManageAccountModule {
    ...
    class Factory(private val accountId: String) : ViewModelProvider.Factory {
        ...
        override fun <T : ViewModel?> create(modelClass: Class<T>): T {
            val service = ManageAccountService(accountId, io.vextabit.bankwallet.core.App.accountManager, io.vextabit.bankwallet.core.App.walletManager, io.vextabit.bankwallet.core.App.restoreSettingsManager)
