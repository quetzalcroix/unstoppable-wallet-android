package io.vextabit.bankwallet.modules.managewallets
...
object ManageWalletsModule {
    ...
    class Factory : ViewModelProvider.Factory {
        ...
        private val manageWalletsService by lazy {
            ManageWalletsService(io.vextabit.bankwallet.core.App.coinManager, io.vextabit.bankwallet.core.App.walletManager, io.vextabit.bankwallet.core.App.accountManager, restoreSettingsService, coinSettingsService)
        }
