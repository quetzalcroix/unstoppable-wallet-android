...
object MarketMetricsModule {
    class Factory : ViewModelProvider.Factory {
        ...
        override fun <T : ViewModel?> create(modelClass: Class<T>): T {
            val service = MarketMetricsService(io.vextabit.bankwallet.core.App.xRateManager, io.vextabit.bankwallet.core.App.backgroundManager, io.vextabit.bankwallet.core.App.currencyManager)
