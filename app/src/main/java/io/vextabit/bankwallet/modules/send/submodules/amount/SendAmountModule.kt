package io.vextabit.bankwallet.modules.send.submodules.amount
...
object SendAmountModule {
    ...
    class Factory(private val wallet: Wallet,
        ...
        override fun <T : ViewModel> create(modelClass: Class<T>): T {
            ...
            val coinDecimal = min(wallet.coin.decimal, io.vextabit.bankwallet.core.App.appConfigProvider.maxDecimal)
            val currencyDecimal = io.vextabit.bankwallet.core.App.appConfigProvider.fiatDecimal
            val baseCurrency = io.vextabit.bankwallet.core.App.currencyManager.baseCurrency

            val interactor = SendAmountInteractor(baseCurrency, io.vextabit.bankwallet.core.App.xRateManager, io.vextabit.bankwallet.core.App.localStorage, wallet.coin, io.vextabit.bankwallet.core.App.backgroundManager)
            val sendAmountPresenterHelper =
                    SendAmountPresenterHelper(io.vextabit.bankwallet.core.App.numberFormatter, wallet.coin, baseCurrency, coinDecimal,
                            currencyDecimal)
