package io.vextabit.bankwallet.modules.sendevm
...
object SendEvmModule {
    ...
    class Factory(private val wallet: Wallet) : ViewModelProvider.Factory {
        private val adapter by lazy { io.vextabit.bankwallet.core.App.adapterManager.getAdapterForWallet(wallet) as ISendEthereumAdapter }
        ...
        override fun <T : ViewModel?> create(modelClass: Class<T>): T {
            return when (modelClass) {
                ...
                AmountInputViewModel::class.java -> {
                    ...
                    val fiatService = FiatServiceSendEvm(switchService, io.vextabit.bankwallet.core.App.currencyManager, io.vextabit.bankwallet.core.App.xRateManager)
                ...
                SendAvailableBalanceViewModel::class.java -> {
                    val coinService = EvmCoinService(wallet.coin, io.vextabit.bankwallet.core.App.currencyManager, io.vextabit.bankwallet.core.App.xRateManager)
                    SendAvailableBalanceViewModel(service, coinService, listOf(service, coinService)) as T
                }
                RecipientAddressViewModel::class.java -> {
                    val addressParser = io.vextabit.bankwallet.core.App.addressParserFactory.parser(wallet.coin)
