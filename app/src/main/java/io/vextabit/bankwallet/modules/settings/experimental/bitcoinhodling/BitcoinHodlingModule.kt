package io.vextabit.bankwallet.modules.settings.experimental.bitcoinhodling
...
object BitcoinHodlingModule {
    ...
    class Factory : ViewModelProvider.Factory {
        ...
        override fun <T : ViewModel> create(modelClass: Class<T>): T {
            ...
            val interactor = BitcoinHodlingInteractor(io.vextabit.bankwallet.core.App.localStorage)
