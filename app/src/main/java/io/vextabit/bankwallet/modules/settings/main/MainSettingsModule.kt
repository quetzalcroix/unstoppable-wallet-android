package io.vextabit.bankwallet.modules.settings.main
    ...
    class Factory : ViewModelProvider.Factory {
        ...
        override fun <T : ViewModel> create(modelClass: Class<T>): T {
            ...
            val interactor = MainSettingsInteractor(
                    localStorage = io.vextabit.bankwallet.core.App.localStorage,
                    backupManager = io.vextabit.bankwallet.core.App.backupManager,
                    languageManager = io.vextabit.bankwallet.core.App.languageManager,
                    systemInfoManager = io.vextabit.bankwallet.core.App.systemInfoManager,
                    currencyManager = io.vextabit.bankwallet.core.App.currencyManager,
                    appConfigProvider = io.vextabit.bankwallet.core.App.appConfigProvider,
                    termsManager = io.vextabit.bankwallet.core.App.termsManager,
                    pinComponent = io.vextabit.bankwallet.core.App.pinComponent,
                    walletConnectSessionManager = io.vextabit.bankwallet.core.App.walletConnectSessionManager
            )
