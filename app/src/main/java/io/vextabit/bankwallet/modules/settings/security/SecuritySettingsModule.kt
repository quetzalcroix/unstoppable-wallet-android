package io.vextabit.bankwallet.modules.settings.security
...
object SecuritySettingsModule {
    ...
    fun init(view: SecuritySettingsViewModel, router: ISecuritySettingsRouter) {
        val interactor = SecuritySettingsInteractor(io.vextabit.bankwallet.core.App.systemInfoManager, io.vextabit.bankwallet.core.App.pinComponent)
