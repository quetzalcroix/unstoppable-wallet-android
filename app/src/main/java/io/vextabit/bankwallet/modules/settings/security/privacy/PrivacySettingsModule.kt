package io.vextabit.bankwallet.modules.settings.security.privacy
...
object PrivacySettingsModule {
    ...
    fun init(view: PrivacySettingsViewModel, router: IPrivacySettingsRouter) {
        val interactor = PrivacySettingsInteractor(
                io.vextabit.bankwallet.core.App.pinComponent,
                io.vextabit.bankwallet.core.App.torKitManager,
                io.vextabit.bankwallet.core.App.initialSyncModeSettingsManager,
