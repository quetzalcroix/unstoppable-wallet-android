package io.vextabit.bankwallet.modules.showkey
...
object ShowKeyModule {
    ...
    class Factory(private val account: Account) : ViewModelProvider.Factory {
        ...
        override fun <T : ViewModel?> create(modelClass: Class<T>): T {
            val service = ShowKeyService(account, io.vextabit.bankwallet.core.App.pinComponent, io.vextabit.bankwallet.core.App.ethereumKitManager, io.vextabit.bankwallet.core.App.accountSettingManager)
