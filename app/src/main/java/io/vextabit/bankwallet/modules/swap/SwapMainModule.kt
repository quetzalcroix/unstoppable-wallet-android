package io.vextabit.bankwallet.modules.swap
...
object SwapMainModule {
    ...
    enum class Blockchain(val id: String, val title: String) : Parcelable {
        ...
        val evmKit: EthereumKit?
            get() = when (this) {
                Ethereum -> io.vextabit.bankwallet.core.App.ethereumKitManager.evmKit
                BinanceSmartChain -> io.vextabit.bankwallet.core.App.binanceSmartChainKitManager.evmKit
            }
        ...
        val coin: Coin?
            get() = when (this) {
                Ethereum -> io.vextabit.bankwallet.core.App.coinKit.getCoin(CoinType.Ethereum)
                BinanceSmartChain -> io.vextabit.bankwallet.core.App.coinKit.getCoin(CoinType.BinanceSmartChain)
            }
    }
    ...
    class CoinCardViewModelFactory(
        ...
        private val coinProvider by lazy {
            SwapCoinProvider(
                ...
                io.vextabit.bankwallet.core.App.currencyManager,
        ...
        override fun <T : ViewModel?> create(
            ...
            return when (modelClass) {
                SwapCoinCardViewModel::class.java -> {
                    val fiatService =
                        FiatService(switchService, io.vextabit.bankwallet.core.App.currencyManager, io.vextabit.bankwallet.core.App.xRateManager)
                    ...
                    val formatter = SwapViewItemHelper(io.vextabit.bankwallet.core.App.numberFormatter)
