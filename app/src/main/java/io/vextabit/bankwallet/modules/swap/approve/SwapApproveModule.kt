package io.vextabit.bankwallet.modules.swap.approve
        ...
        override fun <T : ViewModel> create(modelClass: Class<T>): T {
            return when (modelClass) {
                SwapApproveViewModel::class.java -> {
                    val wallet =
                        checkNotNull(io.vextabit.bankwallet.core.App.walletManager.activeWallets.firstOrNull { it.coin == approveData.coin })
                    val erc20Adapter =
                        io.vextabit.bankwallet.core.App.adapterManager.getAdapterForWallet(wallet) as Eip20Adapter
