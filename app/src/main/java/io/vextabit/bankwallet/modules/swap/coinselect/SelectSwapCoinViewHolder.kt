package io.vextabit.bankwallet.modules.swap.coinselect
    ...
    fun bind(coinItem: CoinBalanceItem, showBottomBorder: Boolean) {
        ...
        coinItem.apply {
            ...
            coinBalance.text = balance?.let {
                io.vextabit.bankwallet.core.App.numberFormatter.formatCoin(it, coin.code, 0, 8)
            }

            fiatBalance.text = fiatBalanceValue?.let {
                io.vextabit.bankwallet.core.App.numberFormatter.formatFiat(fiatBalanceValue.value, fiatBalanceValue.currency.symbol, 0, 2)
            }
        }
    }
