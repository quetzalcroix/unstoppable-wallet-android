package io.vextabit.bankwallet.modules.swap.uniswap
...
object UniswapModule {
    ...
    class Factory(
        ...
        private val allowanceService by lazy { SwapAllowanceService(uniswapProvider.routerAddress, io.vextabit.bankwallet.core.App.adapterManager, evmKit) }
