package io.vextabit.bankwallet.modules.transactionInfo
...
object TransactionInfoModule {
    ...
    class Factory(private val transactionViewItem: TransactionViewItem) :
        ...
        override fun <T : ViewModel?> create(modelClass: Class<T>): T {
            val adapter =
                io.vextabit.bankwallet.core.App.adapterManager.getTransactionsAdapterForWallet(transactionViewItem.wallet)!!
