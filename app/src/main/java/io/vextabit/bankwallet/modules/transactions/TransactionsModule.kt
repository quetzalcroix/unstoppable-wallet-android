    ...
    class Factory : ViewModelProvider.Factory {
        ...
        override fun <T : ViewModel> create(modelClass: Class<T>): T {
            ...
            val dataSource = TransactionRecordDataSource(PoolRepo(), TransactionItemDataSource(), 20, TransactionViewItemFactory(
                TransactionInfoAddressMapper, io.vextabit.bankwallet.core.App.numberFormatter
            ), TransactionMetadataDataSource())
            val interactor = TransactionsInteractor(io.vextabit.bankwallet.core.App.walletManager, io.vextabit.bankwallet.core.App.adapterManager, io.vextabit.bankwallet.core.App.currencyManager, io.vextabit.bankwallet.core.App.xRateManager, io.vextabit.bankwallet.core.App.connectivityManager)
