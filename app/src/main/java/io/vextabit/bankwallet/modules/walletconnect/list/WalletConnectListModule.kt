package io.vextabit.bankwallet.modules.walletconnect.list
...
object WalletConnectListModule {
    ...
    class Factory : ViewModelProvider.Factory {
        ...
        override fun <T : ViewModel?> create(modelClass: Class<T>): T {
            val service = WalletConnectListService(io.vextabit.bankwallet.core.App.walletConnectSessionManager)
