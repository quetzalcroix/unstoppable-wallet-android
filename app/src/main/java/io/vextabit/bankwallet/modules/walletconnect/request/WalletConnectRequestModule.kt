package io.vextabit.bankwallet.modules.walletconnect.request
    ...
    class Factory(
        ...
        private val coin by lazy {
            when (evmKit.networkType) {
                ...
                NetworkType.EthRinkeby -> io.vextabit.bankwallet.core.App.coinManager.getCoin(CoinType.Ethereum)!!
                NetworkType.BscMainNet -> io.vextabit.bankwallet.core.App.coinManager.getCoin(CoinType.BinanceSmartChain)!!
            }
        }
        ...
        private val sendService by lazy { SendEvmTransactionService(SendEvmData(service.transactionData), evmKit, transactionService, io.vextabit.bankwallet.core.App.activateCoinManager, service.gasPrice) }
