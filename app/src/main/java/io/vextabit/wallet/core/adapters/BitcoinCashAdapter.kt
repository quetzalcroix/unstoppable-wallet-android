...
class BitcoinCashAdapter(
    ...
    companion object {
        ...
        private fun createKit(wallet: Wallet, syncMode: SyncMode?, testMode: Boolean): BitcoinCashKit {
            ...
            return BitcoinCashKit(context = io.vextabit.wallet.core.App.instance,
        ...
        fun clear(walletId: String, testMode: Boolean) {
            BitcoinCashKit.clear(io.vextabit.wallet.core.App.instance, getNetworkType(testMode), walletId)
        }
