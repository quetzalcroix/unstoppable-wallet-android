...
import io.vextabit.wallet.core.ISendDashAdapter
    ...
    companion object {
        ...
        private fun createKit(wallet: Wallet, syncMode: SyncMode?, testMode: Boolean): DashKit {
            ...
            if (accountType is AccountType.Mnemonic) {
                return DashKit(context = io.vextabit.wallet.core.App.instance,
        ...
        fun clear(walletId: String, testMode: Boolean) {
            DashKit.clear(io.vextabit.wallet.core.App.instance, getNetworkType(testMode), walletId)
        }
    }
}
