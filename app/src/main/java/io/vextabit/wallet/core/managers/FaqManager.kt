...
import io.vextabit.wallet.entities.Faq
import io.vextabit.wallet.entities.FaqMap
...
object FaqManager {
    ...
    private val faqListUrl = io.vextabit.wallet.core.App.appConfigProvider.faqUrl
