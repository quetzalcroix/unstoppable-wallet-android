...
import io.vextabit.wallet.entities.Guide
import io.vextabit.wallet.entities.GuideCategoryMultiLang
...
object GuidesManager {
    ...
    private val guidesUrl = io.vextabit.wallet.core.App.appConfigProvider.guidesUrl
