...
class SystemInfoManager : ISystemInfoManager {
    ...
    private val biometricManager by lazy { BiometricManager.from(io.vextabit.wallet.core.App.instance) }

    override val isSystemLockOff: Boolean
        get() {
            val keyguardManager = io.vextabit.wallet.core.App.instance.getSystemService(Activity.KEYGUARD_SERVICE) as KeyguardManager
