...
object ManageAccountModule {
    ...
    class Factory(private val accountId: String) : ViewModelProvider.Factory {
        ...
        override fun <T : ViewModel?> create(modelClass: Class<T>): T {
            val service = ManageAccountService(accountId, io.vextabit.wallet.core.App.accountManager, io.vextabit.wallet.core.App.walletManager, io.vextabit.wallet.core.App.restoreSettingsManager)
