...
object MarketMetricsModule {
    class Factory : ViewModelProvider.Factory {
        ...
        override fun <T : ViewModel?> create(modelClass: Class<T>): T {
            val service = MarketMetricsService(io.vextabit.wallet.core.App.xRateManager, io.vextabit.wallet.core.App.backgroundManager, io.vextabit.wallet.core.App.currencyManager)
