...
import io.vextabit.wallet.modules.market.getBackgroundTintColor
import io.vextabit.wallet.modules.market.getText
import io.vextabit.wallet.modules.market.getTextColor
            ...
            when (marketField) {
                ...
                is MarketViewItem.MarketDataValue.Diff -> {
                    ...
                    if(v != null) {
                        ...
                        marketFieldValue.text = io.vextabit.wallet.core.App.numberFormatter.format(v.abs(), 0, 2, sign, "%")
