...
class RestorePrivateKeyViewModel(private val service: RestorePrivateKeyService, private val clearables: List<Clearable>) : ViewModel() {
    ...
    fun onProceed() {
        ...
        } catch (t: RestorePrivateKeyService.RestoreError.EmptyPassphrase) {
