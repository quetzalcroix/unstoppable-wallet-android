package io.vextabit.wallet.modules.send.submodules.amount
...
object SendAmountModule {
    ...
    class Factory(private val wallet: Wallet,
        ...
        override fun <T : ViewModel> create(modelClass: Class<T>): T {
            ...
            val coinDecimal = min(wallet.coin.decimal, io.vextabit.wallet.core.App.appConfigProvider.maxDecimal)
            val currencyDecimal = io.vextabit.wallet.core.App.appConfigProvider.fiatDecimal
            val baseCurrency = io.vextabit.wallet.core.App.currencyManager.baseCurrency

            val interactor = SendAmountInteractor(baseCurrency, io.vextabit.wallet.core.App.xRateManager, io.vextabit.wallet.core.App.localStorage, wallet.coin, io.vextabit.wallet.core.App.backgroundManager)
            val sendAmountPresenterHelper =
                    SendAmountPresenterHelper(io.vextabit.wallet.core.App.numberFormatter, wallet.coin, baseCurrency, coinDecimal,
                            currencyDecimal)
