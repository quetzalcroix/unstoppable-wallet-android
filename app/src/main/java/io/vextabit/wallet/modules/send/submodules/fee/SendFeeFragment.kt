...
import io.vextabit.wallet.modules.send.SendActivity
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        presenterView.insufficientFeeBalanceError.observe(viewLifecycleOwner, Observer { error ->
            ...
            if (error != null) {
                ...
                val formattedFee = io.vextabit.wallet.core.App.numberFormatter.formatCoin(error.fee.value, error.fee.coin.code, 0, 8)
