    ...
    class Factory : ViewModelProvider.Factory {
        ...
        override fun <T : ViewModel> create(modelClass: Class<T>): T {
            ...
            val interactor = MainSettingsInteractor(
                    localStorage = io.vextabit.wallet.core.App.localStorage,
                    backupManager = io.vextabit.wallet.core.App.backupManager,
                    languageManager = io.vextabit.wallet.core.App.languageManager,
                    systemInfoManager = io.vextabit.wallet.core.App.systemInfoManager,
                    currencyManager = io.vextabit.wallet.core.App.currencyManager,
                    appConfigProvider = io.vextabit.wallet.core.App.appConfigProvider,
                    termsManager = io.vextabit.wallet.core.App.termsManager,
                    pinComponent = io.vextabit.wallet.core.App.pinComponent,
                    walletConnectSessionManager = io.vextabit.wallet.core.App.walletConnectSessionManager
            )
