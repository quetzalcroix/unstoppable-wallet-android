        ...
        override fun <T : ViewModel> create(modelClass: Class<T>): T {
            return when (modelClass) {
                SwapApproveViewModel::class.java -> {
                    val wallet =
                        checkNotNull(io.vextabit.wallet.core.App.walletManager.activeWallets.firstOrNull { it.coin == approveData.coin })
                    val erc20Adapter =
                        io.vextabit.wallet.core.App.adapterManager.getAdapterForWallet(wallet) as Eip20Adapter
