    ...
    fun bind(coinItem: CoinBalanceItem, showBottomBorder: Boolean) {
        ...
        coinItem.apply {
            ...
            coinBalance.text = balance?.let {
                io.vextabit.wallet.core.App.numberFormatter.formatCoin(it, coin.code, 0, 8)
            }

            fiatBalance.text = fiatBalanceValue?.let {
                io.vextabit.wallet.core.App.numberFormatter.formatFiat(fiatBalanceValue.value, fiatBalanceValue.currency.symbol, 0, 2)
            }
        }
    }
