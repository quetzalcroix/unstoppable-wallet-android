...
import io.vextabit.wallet.entities.CoinSettings
    ...
    class Factory : ViewModelProvider.Factory {
        ...
        override fun <T : ViewModel> create(modelClass: Class<T>): T {
            ...
            val dataSource = TransactionRecordDataSource(PoolRepo(), TransactionItemDataSource(), 20, TransactionViewItemFactory(
                TransactionInfoAddressMapper, io.vextabit.wallet.core.App.numberFormatter
            ), TransactionMetadataDataSource())
            val interactor = TransactionsInteractor(io.vextabit.wallet.core.App.walletManager, io.vextabit.wallet.core.App.adapterManager, io.vextabit.wallet.core.App.currencyManager, io.vextabit.wallet.core.App.xRateManager, io.vextabit.wallet.core.App.connectivityManager)
